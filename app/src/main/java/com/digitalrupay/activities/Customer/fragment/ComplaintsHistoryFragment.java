...
public class ComplaintsHistoryFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_customer_complaint, container, false);
    ...
    public void setComplaints(ArrayList<ComplaintsListModelDB> complaintsDataModelArrayList, String message, String text) {
        if (complaintsDataModelArrayList != null && complaintsDataModelArrayList.size() > 0) {
            ComplaintsListAdapter complaintsListAdapter = new ComplaintsListAdapter(getActivity(), complaintsDataModelArrayList);
